...
DefaultFormat = (('currency', {
    ...
    'num_format': 'yyyy-mm-dd hh:mm:ss.0'
}))
...
class Book(Workbook):
    ...
    def write(self,
        ...
        if (last_row is None) or (first_row == last_row
                                  and first_col == last_col):
            if isinstance(value, (tuple, list)):
                self.worksheet.write_row(first_row, first_col, value,
                                         cell_format)
            else:
    ...
    def _add_table(self,
        ...
        if data:
            ...
            if kwargs.get('total_row', False):
                last_row += 1
            kwargs['data'] = data
        self.worksheet.add_table(first_row, first_col, last_row, last_col,
                                 kwargs)
